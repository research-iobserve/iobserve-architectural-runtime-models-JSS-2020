...
public final class SimpleBranchReference {
    ...
    public static ReferenceElements getModel(final String referenceModelFileName,
        ...
        final int numberOfBranchTransitions = ExperimentHelper.getRandomInteger(5, 2);
        final int numberOfConcurrentUsers = ExperimentHelper.getRandomInteger(200, 10 * numberOfBranchTransitions);
        ...
        ExperimentHelper.saveModel(usageModel, referenceModelFileName);
