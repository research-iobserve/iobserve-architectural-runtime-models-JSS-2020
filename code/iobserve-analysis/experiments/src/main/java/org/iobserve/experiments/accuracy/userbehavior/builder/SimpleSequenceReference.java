...
public final class SimpleSequenceReference {
    ...
    public static ReferenceElements getModel(final String referenceUsageModelFileName,
        ...
        final int numberOfUsersSessions = ExperimentHelper.getRandomInteger(200, 1);
        final int numberOfCalls = ExperimentHelper.getRandomInteger(5, 1);

        final EntryCallSequenceModel entryCallSequenceModel = new EntryCallSequenceModel(
                ExperimentHelper.getUserSessions(numberOfUsersSessions));
        ...
        int entryTime = 0;
        int exitTime = 1;
        final int meanInterArrivalTime = ExperimentHelper.getRandomInteger(30, 1);

        for (int i = 0; i < entryCallSequenceModel.getUserSessions().size(); i++) {
            if (isClosedWorkload) {
                entryTime = ExperimentHelper.getRandomInteger(30, 1);
