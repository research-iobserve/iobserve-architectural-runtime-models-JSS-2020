...
public final class LoopWithinBranchReference {
    ...
    public static ReferenceElements getModel(final String referenceUsageModelFileName,
        ...
        final int numberOfBranchTransitions = ExperimentHelper.getRandomInteger(3, 2);
        final int numberOfConcurrentUsers = ExperimentHelper.getRandomInteger(200, 10 * numberOfBranchTransitions); //30
        final int lengthOfBranchSequence = ExperimentHelper.getRandomInteger(2, 1);
        final int countOfLoop = ExperimentHelper.getRandomInteger(3, 2);
        ...
        do {
            ...
            for (int i = 0; i < entryCallSequenceModel.getUserSessions().size(); i++) {
                ...
                final int branchDecisioner = ExperimentHelper.getRandomInteger(numberOfBranchTransitions - 1, 0);
