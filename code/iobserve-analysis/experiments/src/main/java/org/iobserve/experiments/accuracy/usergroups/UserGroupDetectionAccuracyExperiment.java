 ...
 ***************************************************************************/
package org.iobserve.experiments.accuracy.usergroups;
...
/**
 * Contains the experiment of the clustering of user groups. For three user groups user sessions 
 * with a user group specific user behavior are created and each user session is labeled with its 
 * user group belonging. Subsequently, the user sessions are clustered and it is evaluated how 
 * accurate our approach assigns user sessions of a user group to the same cluster
 *
 * @author David Peter, Robert Heinrich, Nicolas Boltz
 */
public class UserGroupDetectionAccuracyExperiment {
     ...
     * Default constructor.
     */
    public UserGroupDetectionAccuracyExperiment(int customerCount, int stockManagerCount, int storeManagerCount, int varianceValue, int evaluationIterations) {
